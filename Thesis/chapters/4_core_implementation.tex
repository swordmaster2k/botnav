...
\caption{A plot file for the first path from the sample map generated by gnuplot (left), and the contents of the output folder after the run. Note that each folder is timestamped (right).} 
\label{sample_output}
